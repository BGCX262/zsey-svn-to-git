...
<div class="main">
	...
	<form name="form1" action="<c:url value='/basic/product/index.jhtml'/>" method="post">
    <div class="frmBar mT5">
		...
		<input type="button" class="btn" value="添加" onclick="location.href='<c:url value='/basic/product/edit.jhtml'/>'"/>
	</div>
	</form>
    ...
    <div class="ntable_mid mT5">
		<display:table name="pageList" id="vo" class="nm_table" style="width:100%" cellspacing="0" requestURI="index.jhtml">
			...
			<display:column title="操作" style="width:150px;">
				<span class="caozuo">
					<a href="javascript:void(null);" onclick="openDialog('details.jhtml?id=${vo.id}','${vo.name}的详情');" class="show">详情</a>&nbsp;|&nbsp;
