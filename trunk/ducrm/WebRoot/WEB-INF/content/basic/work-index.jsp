...
<div class="main">
	...
	<form name="form1" action="<c:url value='/basic/work/index.jhtml'/>" method="post">
    <div class="frmBar mT5">
		...
		<input type="button" class="btn" value="添加" onclick="location.href='<c:url value='/basic/work/edit.jhtml'/>'"/>
	</div>
	</form>
    ...
    <div class="ntable_mid mT5">
		<display:table name="pageList" id="vo" class="nm_table" style="width:100%" cellspacing="0" requestURI="index.jhtml">
			...
			<display:column title="备注" style="width:200px;">${vo.remark}</display:column>
