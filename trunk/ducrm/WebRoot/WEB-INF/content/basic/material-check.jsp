...
<div style="height:400px !important;overflow:hidden;">
	<div id="formbody" style="padding:0px;">
		...
		<iframe id="listframe" name="listframe"  src="<c:url value='/basic/material/multi.jhtml?vo.provider.id=${vo.provider.id}'/>" width="100%" height="300px" frameborder="none" scrolling-y="none"></iframe>
	</div>
</div>
</body>
</html>