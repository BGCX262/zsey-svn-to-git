...
<div class="main">
    <div class="subTitle">
        <h2><strong>询价确认管理</strong></h2>
    </div>
	<form name="form1" action="<c:url value='/buy/buy-price-audit/index.jhtml'/>" method="post">
    ...
    <div class="ntable_mid mT5">
		<display:table name="pageList" id="vo" class="nm_table" style="width:100%" cellspacing="0" requestURI="index.jhtml">
			...
			<display:column title="操作" style="width:100px;">
				<span class="caozuo">
					<a href="javascript:void(null);" onclick="openDialog('<c:url value="/buy/buy-price/details.jhtml?id=${vo.id}"/>','${vo.code }的物料询价详情');" class="show">详情</a>
					&nbsp;|&nbsp;<a href="edit.jhtml?id=${vo.id }" class="edit">确认</a>
				</span>
			</display:column>
			<display:setProperty name="paging.banner.item_name">询价确认</display:setProperty>
			<display:setProperty name="paging.banner.items_name">询价确认</display:setProperty>
		</display:table>
	</div>
