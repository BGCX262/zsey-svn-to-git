...
<div class="main">
	...
	<form name="form1" action="<c:url value='/buy/buy-order-audit/index.jhtml'/>" method="post">
    ...
    <div class="ntable_mid mT5">
		<display:table name="pageList" id="vo" class="nm_table" style="width:100%" cellspacing="0" requestURI="index.jhtml">
			...
			<display:setProperty name="paging.banner.item_name">采购审核</display:setProperty>
			<display:setProperty name="paging.banner.items_name">采购审核</display:setProperty>
		</display:table>
	</div>
