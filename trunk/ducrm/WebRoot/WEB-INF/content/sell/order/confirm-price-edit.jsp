...
<div class="main">
	...
	<h3 class="subBoxTitle mT5">客户报价确认</h3>
<form name="form1" action="<c:url value='/sell/order/confirm-price/save.jhtml' />" method="post" onsubmit="return Validator.Validate(this,3);" enctype="multipart/form-data">
	...
	<div class="nbot_control mT10">
		...
		<input type="button" class="formBtn02" value="返 回" onclick="location.href='<c:url value='/sell/order/confirm-price/index.jhtml' />';" />
    </div>
</form>
</div>
</body>
